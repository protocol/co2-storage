...
<template>
	<section :class="templatesClass">
		...
		<div class="main-container"
			v-if="!noFunction && !noInputs && validatedTemplate && template != null && ipfsChainName != null">
		...
		<div class="main-container"
			...
			<div class="grid-container">
				...
				<div class="metadata-container error">
					<div class="heading">{{ $t('message.functions.function-does-not-exists', {functionContainer: functionContainer}) }}</div>
				</div>
			</div>
		</div>
		<div class="main-container"
			...
			<div class="grid-container">
				...
				<div class="metadata-container">
					<div class="heading">{{ $t('message.functions.function-does-not-require-any-inputs', {functionName: functionName}) }}</div>
				</div>
				<div class="controls"
					v-if="!nonEthereumBrowserDetected">
					<Button :label="$t('message.functions.run-function')" icon="pi pi-cloud-upload" class="p-button-success"
		...
		<div class="main-container"
			...
			<div class="grid-container">
				...
				<div class="metadata-container">
					<div class="heading">{{ $t('message.functions.loading-template') }}</div>
				</div>
			</div>
		</div>
		<div class="main-container"
			...
			<div class="grid-container">
				...
				<div class="metadata-container error">
					<div class="heading">{{ $t('message.functions.invalid-template', {functionName: functionName}) }}</div>
				</div>
			</div>
		</div>
		<div class="main-container"
