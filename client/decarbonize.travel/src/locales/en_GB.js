export default {
	"message": {
		...
		"functions": {
			"run-function": "Decarbonize my travel",
			"function-does-not-exists": "Provided function {functionContainer} does not exist.",
			"function-does-not-require-any-inputs": "Function {functionName} does not require any inputs.",
			"invalid-template": "Can not find template type for function {functionName}.",
			"loading-template": "Loading template..."
		},
		"travel-decarbonization": {
			"signing-input-travel-data": "Signing input travel data",
			"preparing-job": "Setting up travel decarbonization job",
			"running-job": "Running travel decarbonization job",
			"must-sign-input-travel-data": "You must sign input data and verify that the decarbonization information is correct.",
			"started": "Started",
