export default {
	"message": {
		...
		"shared": {
			...
			"non-ethereum-browser-detected": "This pipeline inspector requires a wallet to read data. Try using Metamask or Brave."
		},
		"functions": {
			"retired": "Retired",
			"active": "Active",
		...
		"pipelines": {
			...
			"function": "Function",
			"data": "Data",
			"invalid-cid": "Invalid Pipeline CID is provided",
			"loading-pipeline-data": "Loading selected pipeline data"
		},
		"helpers": {
			"contributor": {
